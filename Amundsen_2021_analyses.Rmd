...
```{r map-area}
tibble(lat = c(72.7491, 75.9631, 76.0355, 78.1672),
       lon = c(-67.0011, -85.5952, -77.2374, -74.8258),
       station = c("BB2", "DE420", "DE110", "DE320")) %>%
  # Map
  ggplot() +
  # Bathymetry
  geom_tile(data = filter(bathy, depth <= 20),
            aes(x = lon, y = lat, fill = depth),
            alpha = 0.7) +
  scale_fill_cmocean("Depth (m)", name = "deep", discrete = F, direction = -1) +
  # Coastlines
  ...
  scale_x_continuous("Longitude (°E)", 
                     breaks = c(-85.12, -80.02, -75, -70, -64.78), 
                     labels = seq(-85, -65, 5)) +
  # Latitude lines
  geom_segment(aes(x = -120, xend = 0, y = 71, yend = 71), col = "grey90", size = 0.3, lty = 2) +
  geom_segment(aes(x = -120, xend = 0, y = 72, yend = 72), col = "grey90", size = 0.3, lty = 2) +
  geom_segment(aes(x = -120, xend = 0, y = 73, yend = 73), col = "grey90", size = 0.3, lty = 2) +
  ...
  scale_y_continuous("Latitude (°N)",
                     breaks = c(71.01, 72.05, 73.09, 74.15, 75.2, 76.25, 77.32, 78.4), 
                     labels = seq(71, 78, 1)) +
  # Labels
  annotate("text", y = 77, x = -84, label = "Ellesmere Isl.", color = "grey20", fontface = "italic") +
  annotate("text", y = 75.2, x = -84, label = "Devon Isl.", color = "grey20", fontface = "italic") +
  annotate("text", y = 78, x = -63, label = "Greenland", color = "grey20", fontface = "italic") +
  annotate("text", y = 71.2, x = -80, label = "Baffin Isl.", color = "grey20", fontface = "italic") +
  # Stations
  geom_point(aes(x = lon, y = lat), col = "darkorange", size = 3) + 
  geom_text(aes(x = lon, y = lat, label = station), col = "black", hjust = -0.1, vjust = -0.5) + 
  # Change map projection
  # coord_map("azequidistant", ylim = c(70.8, 78.5), xlim = c(-86, -65)) +
  coord_quickmap(ylim = c(71.2, 78.5), xlim = c(-86, -65)) +
