...
The Underwater Vision Profiler 6 (UVP) was mounted on the CTD rosette and collected images throughout the water column. Pictures were sorted according to taxonomic composition using EcoTaxa (ref). 

I load the entire UVP dataset.
...
Then, I tidy the UVP data and select for variables of interest
...
UVP <- UVP_raw %>%
  ...
  # Select variables of interest
  dplyr::select(date, station, profile, cast_number, sampleid, lat, lon, ice, 
                depth, depth_bin, watervolume, taxon, lineage)
```
